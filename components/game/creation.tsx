...
export function Creation({
  ...
  const [creationView, setCreationView] = useState("basic");
  ...
  return (
    <form
      ...
      onInvalidCapture={(event) => {
        ...
        const view = target.closest<HTMLElement>("[data-creation-page]")?.dataset.creationPage;
        if (view) setCreationView(view);
    ...
    >
      ...
      />
      <PagedContent label="创建角色" resetKey={creationView}>
        <div
          className="creation-essential"
          data-creation-page="basic"
          hidden={creationView !== "basic"}
        >
          ...
          <fieldset>
            ...
            <RadioGroup
              ...
              onValueChange={(v) =>
                update("appearance", { ...profile.appearance, face: Number(v) })
              }
        ...
        <div className="creation-advanced-panels">
          <div className="creation-advanced">
            {utilities && (
              <div
                className="creation-utilities"
                data-creation-page="tools"
                hidden={creationView !== "tools"}
              >
                {utilities}
              </div>
            )}
            <div data-creation-page="shape" hidden={creationView !== "shape"}>
              <AppearanceFields
                omitFace
                sex={profile.sex}
            ...
            <div
              className="creation-fate"
              data-creation-page="fate"
              hidden={creationView !== "fate"}
            >
              <label className="form-field seed-field">
                ...
                />
                <small>
                  相同种子重现相同初始世界。默认 12345
                  与现有角色原画配套；修改会改变世界与随机人物。
                </small>
              </label>
            ...
            <div
              className="creation-portrait-panel"
              data-creation-page="portrait"
              hidden={creationView !== "portrait"}
            >
            ...
            <div
              className="creation-file-options"
              data-creation-page="tools"
              hidden={creationView !== "tools"}
            >
