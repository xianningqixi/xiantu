...
主分支整合时补充了可随仓库携带的 [257 个素材位新旧对照](../../docs/reports/ART-REFRESH-2026-09-10.html)，缩略图和最终 WebP 都通过仓库内相对路径引用。合并后的桌面／手机交互检查另见 [2026-09-10 同步记录](../../docs/reports/GITHUB-SYNC-2026-09-10.md)；制作阶段记录与原生 PNG 继续保留在本机。
