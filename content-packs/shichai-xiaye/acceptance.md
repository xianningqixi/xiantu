...
本卷 31 张 PNG 已通过 art/manifest.json 接入，所有视觉槽位 owned，女角色 portraitId 已登记。派生 WebP 共 2,840,936 字节，全部 lazy；图片摘要与锁保存在本卷 integrity.json，原 storylets／outline／art-prompts／PNG 未改。
...
本卷当前 lock：`shichai.xiaye@0.1.0:c81a97f792f7c7eea8965b25e2fc3a238e31fb3cd7b30384a807485f9ec45b93`。
...
| 路线 | 预期流程 | 状态 |
| --- | --- | --- |
| 裴姒（情敌 沈万山） | 相识→相知→心动→情敌介入→初夜→双修→道侣；退让分支进入被夺结局；身故分支收束 | 道侣路线规则测试通过；完整浏览器分支未逐条试玩 |
| 沈栖月（情敌 陆青遥） | 相识→相知→心动→情敌介入→初夜→双修→道侣；退让分支进入被夺结局；身故分支收束 | 道侣路线规则测试通过；完整浏览器分支未逐条试玩 |
| 柳含烟（情敌 韩铁衣） | 相识→相知→心动→情敌介入→初夜→双修→道侣；退让分支进入被夺结局；身故分支收束 | 道侣路线规则测试通过；完整浏览器分支未逐条试玩 |
